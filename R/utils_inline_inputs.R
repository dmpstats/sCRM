#' @name inumericInput
#' @title Create a numeric input with a label either left, above, or both left
#'   and above the input. With no label it becomes an 'inline' input suitable
                           ...
                           container=list(outer=shiny::div, inner=shiny::span)) 
{
  inputTag <- shiny::tags$input(id = inputId, type = "number", 
                                class = "form-control", style=input.style, 
  ...
  container[['outer']](class = "form-group shiny-input-container", 
...
#' @name itextInput
#' @title Create a text input with a label either left, above, or both left and
#'   above the input. With no label it becomes an 'inline' input suitable for

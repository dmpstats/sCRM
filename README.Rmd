...
offering a user-friendly interactive platform to run Collision Risk
Models (CRMs) for seabird species under multiple wind farm scenarios.
...
sCRM's current release is a Beta version and will be undergoing testing. It is intended to
eventually replace the [stochCRM](https://github.com/dmpstats/stochCRM) tool.
...
Assuming that a recent version of [R](https://cran.r-project.org/) (>4.1) has been installed, run the following commands to install `{sCRM}`:
